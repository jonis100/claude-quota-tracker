...
[![VS Marketplace Downloads](https://vsmarketplacebadges.dev/downloads-short/yonis.claude-quota-tracker.svg
)](https://marketplace.visualstudio.com/items?itemName=yonis.claude-quota-tracker)
